...
const MathPuzzle = ({ question, answer, onComplete }) => {
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-lg mx-4">
      <h3 className="text-xl font-bold text-slate-800 mb-2">Math Puzzle</h3>
      <p className="text-slate-600 text-base mb-4 text-center max-w-xs">{question}</p>
